...
- An In-Memory [Key-Value Store](../../Key-Value%20Store.md)
...
## Deep Dive into REDIS Dataypes

![inline fit](../attachments/redis_datatypes.png)
...
![right fit](../attachments/redis_kv.png)
...
- You are free to choose your own naming conventions, but..
	- Be Consistent
	- Use Namespaces
		- domain_object:uniqueID, e.g., event:Balon_DOR
	- Case sensistive
	- Distinguish values from collections (plural)

![right fit](../attachments/things-i-hate-vandalism-lists-irony-lists-repetition-inconsistency.jpg)
